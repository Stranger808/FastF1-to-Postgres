...
def clean_and_recreate_tables(engine, schema='public'):
    """
    Complete process to clean up and recreate tables
    """
    print("=== PHASE 1: Dropping all constraints and indexes ===")
    drop_all_constraints_and_indexes(engine, schema)
    
    print("\n=== PHASE 2: Creating new table structure ===")
    # Create tables first without constraints
    create_fastf1_tables_without_constraints(engine, schema)
    
    print("\n=== PHASE 2.5: Adding constraints ===")
    # Add constraints in a separate transaction
    add_constraints_to_tables(engine, schema)
    
    print("\n=== PHASE 3: Creating indexes and foreign keys ===")
    create_indexes_and_foreign_keys(engine, schema)
    
    print("\n=== PHASE 4: Analyzing tables ===")
    analyze_tables(engine, schema)
